...
const personalMonthStart = makeUtcDate(selectedYear - 12, selectedMonth, Math.min(selectedDay, 5), 14, 0, 0);
...
const personalDayOfMonthStart = makeUtcDate(selectedYear - 2, dayOfMonthMonth, selectedDay, 9, 0, 0);
...
const nuxt = spawn(process.execPath, [
  nuxtCli,
  'dev',
], {
  cwd: rootDir,
